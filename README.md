...
- Answer: I learned how to create a middleware and create routes for specific API Endpoints.

- [X] Describe Middleware?

- Answer: A Middleware is a function that basically access the req, res, next. 

- [X] Describe a Resource?

- Answer: A Resource is all the data that an API or your server may have.

- [X] What can the API return to help clients know if a request was successful?

- Answer: What the API returns is important. For this situation it will be a 200 OK. There 
    are others like 201 For Created Successful. 

- [X] How can we partition our application into sub-applications?

- Answer: You are able to accomplish this with routing. 
